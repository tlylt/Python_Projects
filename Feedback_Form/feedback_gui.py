...
class Feedback:
    def __init__(self,master):
        ...
        ttk.Label(self.frame_header,text="This is a feedback form",style="Header.TLabel").grid(row=0,column=1,padx=5)
        ttk.Label(self.frame_header,wraplength=300,text="We're glad that you made it. Please tell us what you thought.").grid(row=1,column=1,padx=5)
